...
class PipelineTestHelper extends BasePipelineTest {
    ...
    void setJobVariables() {
        ...
        Build mockBuild = mock(FreeStyleBuild.class);
        mockBuild.addOrReplaceAction(new ApproverAction("eggo1060"))
        /**
         * The currentBuild in the job
         */
        binding.setVariable('currentBuild', new Expando(result: 'SUCCESS', displayName: 'Build #1234', currentResult: 'SUCCESS', ))
        binding.getVariable('currentBuild').setProperty("rawBuild", mockBuild)
        /**
         * agent any
         * agent none
         */
