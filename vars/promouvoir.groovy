...
def check(def config) {
    ...
    if (!config.promotion) {
        throw new Exception("Le parametre 'promotion' est obligatoire et prend pour valeur une instance de l'énumération fr.pe.jenkins.plugins.util.plugins.PromotionStatus.")
    }
