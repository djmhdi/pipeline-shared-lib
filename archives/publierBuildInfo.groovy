...
def check(def config) {
    ...
    if (!config.currentPromotion) {
        throw new Exception("Le parametre 'currentPromotion' est obligatoire et prend pour valeur une instance de l'énumération com.capgemini.fs.jenkins.plugins.util.plugins.PromotionStatus.")
    }
