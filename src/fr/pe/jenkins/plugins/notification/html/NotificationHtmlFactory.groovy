package fr.pe.jenkins.plugins.notification.html

import fr.pe.jenkins.plugins.bundle.Bundle
import fr.pe.jenkins.plugins.notification.library.NotificationFactory
...
class NotificationHtmlFactory {
    ...
    private static Logger logger = Logger.getLogger('fr.pe.jenkins.plugins.notification.html.NotificationHtmlFactory')
