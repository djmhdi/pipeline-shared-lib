...
import static fr.pe.jenkins.plugins.proven.ProvenResource.dictionaryGavFor
import static fr.pe.jenkins.plugins.proven.ProvenResource.targetsDescriptorFor

class CheckDeployment {

	static Logger logger = Logger.getLogger('fr.pe.jenkins.plugins.deploy.CheckDeploy')
