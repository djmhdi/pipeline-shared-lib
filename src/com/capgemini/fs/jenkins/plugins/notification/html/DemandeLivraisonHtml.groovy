...
@Deprecated
class DemandeLivraisonHtml extends DemandeLivraison {

	static Logger logger = Logger.getLogger('com.capgemini.fs.jenkins.plugins.notification.html.DemandeLivraisonHtml')
