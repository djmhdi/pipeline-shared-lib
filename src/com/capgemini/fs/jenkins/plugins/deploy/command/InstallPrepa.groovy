...
class InstallPrepa implements Serializable {

	static Logger logger = Logger.getLogger('com.capgemini.fs.jenkins.plugins.deploy.command.InstallPrepa')
	...
	def execute(script, def bundle, def pvnTarget, def pvnDictionary) {
		...
		String fadiaCommand = FadiaScripts.INSTALL_PREPA.cmd
